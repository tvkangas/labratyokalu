...
/**
 * Luokka luo Numero luokan toteuttavan olion, joka piirtää numeron kahdeksan
 */

public class Kahdeksan extends Numero {

    public Kahdeksan(int x, int y, int koko, Color vari) {
        super(x, y, koko, vari);
    }
